  ...
  return (
    ...
    >
      <div className="h-full flex flex-col">
        {/* Header avec logo IT ROAD GROUP */}
        ...
        <div className="p-4 border-t border-gray-100">
          <button className="flex items-center w-full px-4 py-3 text-gray-500 hover:text-red-500 hover:bg-red-50 rounded-lg transition-all duration-200 group">
            <LogOut
